...
def model_components():
    ...
    pre_train_path = './pre_trained_gnn/{}.GraphCL.{}.pth'.format('CiteSeer', gnn_type)
...
if __name__ == '__main__':
    ...
    meta_train_task_id_list = [12, 13, 14, 15]
    meta_test_task_id_list = [16, 17]

    #meta_train_task_id_list = [14, 15, 16, 17, 18]
    #meta_test_task_id_list = [19, 20]

    pre_train_method = 'GraphCL' # 'GraphCL', 'SimGRACE'
    gnn_type = 'TransformerConv' # 'GAT', 'GCN'， 'TransformerConv'
    ...
    meta_train_maml(20, maml, gnn, lossfn, opt, meta_train_task_id_list,
                    dataname, adapt_steps=2, K_shot=10)

    # meta testing on target tasks
    adapt_steps_meta_test = 2  # 00  # 50
    meta_test_adam(meta_test_task_id_list, dataname, 10, seed, maml, gnn,
