...
def induced_graph_2_K_shot(t1_dic, t2_dic, dataname: str = None,
    ...
    if not task_data:
        raise ValueError(f"task_data is empty for dataset {dataname}. Please check the input data and parameters.")
...
if __name__ == '__main__':
    ...
    dataname = 'PubMed'  # 'CiteSeer'，'PubMed'，'Cora'，'Computers'
    ...
    print("node_classes: ", node_classes)
    #
